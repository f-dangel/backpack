"""Test recursive HBP of Conv2d layer with non-trivial hyper parameters.
...
from bpexts.hbp.conv2d_recursive import HBPConv2dRecursive
...
def hbp_from_torch_fn():
    ...
    layer = HBPConv2dRecursive.from_torch(torch_layer)
    assert isinstance(layer, HBPConv2dRecursive)
    return layer
