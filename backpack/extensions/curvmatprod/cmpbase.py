...
class CMPBase(ModuleExtension):
    ...
    def backpropagate(self, ext, module, g_inp, g_out, backproped):
        ...
        residual = self._second_order_module_effects(module, g_inp, g_out)
        ...
        def CMP_in(mat):
            ...
            """
            Jmat = self.derivatives.jac_mat_prod(
                module, g_inp, g_out, mat
            )
            CJmat = CMP_out(Jmat)
            JTCJmat = self.derivatives.jac_t_mat_prod(
    ...
    def _second_order_module_effects(self, module, g_inp, g_out):
