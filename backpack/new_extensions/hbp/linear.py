...
class HBPLinear(HBPBaseModule):
    ...
    def weight(self, ext, module, g_inp, g_out, backproped):
        ...
        if BackpropStrategy.is_batch_average(bp_strategy):
            return self._weight_for_batch_average(ext, module, g_inp, g_out, backproped)

        elif BackpropStrategy.is_sqrt(bp_strategy):
            return self._weight_for_sqrt(ext, module, g_inp, g_out, backproped)

    def _weight_for_batch_average(self, ext, module, g_inp, g_out, backproped):
        kron_factors = self._bias_for_batch_average(
    ...
    def _weight_for_sqrt(self, ext, module, g_inp, g_out, backproped):
        kron_factors = self._factor_from_sqrt(
            ext, module, g_inp, g_out, backproped
        )
        kron_factors += self._factors_from_input(
            ext, module, g_inp, g_out, backproped
    ...
    def _bias_for_batch_average(self, ext, module, g_inp, g_out, backproped):
        return [backproped]
...
class HBPLinearConcat(HBPBaseModule):
    ...
    def weight(self, ext, module, g_inp, g_out, backproped):
        ...
        if BackpropStrategy.is_batch_average(bp_strategy):
            return self._weight_for_batch_average(
                ext, module, g_inp, g_out, backproped
            )
        elif BackpropStrategy.is_sqrt(bp_strategy):
            return self._weight_for_sqrt(
                ext, module, g_inp, g_out, backproped
            )
